...
Perf = Statistics_of_Simulation(P, number_of_runs, ratio, l, h, Dist_Matrix_1,Dist_Matrix_2,Dist_Matrix_3,radius)
...
while elapsed < 400:
    ...
    for j in range(n):
        ...
        P_1 = Neighbourhood(P, number_of_runs, ratio, l, h, Dist_Matrix_1, Dist_Matrix_2, Dist_Matrix_3,radius)
        Perf_1 = Statistics_of_Simulation(P_1, number_of_runs, ratio, l, h, Dist_Matrix_1,Dist_Matrix_2,Dist_Matrix_3, radius)
        f_1 = Perf_1[2]
...
for j in range(5):
    ...
    for i in range(5):
        resampled[i,0:3] = Statistics_of_Simulation(Result_sorted_5[j,0:8], number_of_runs, ratio, l, h, Dist_Matrix_1,Dist_Matrix_2,Dist_Matrix_3, radius)[0:3]
