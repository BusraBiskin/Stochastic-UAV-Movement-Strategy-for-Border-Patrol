...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr  3 17:11:58 2023
...
Result_sorted = Result[(-Result[:,6]).argsort()] #ordering solutions wrt fitness values, increasing order
...
for j in range(5):
    ...
    for i in range(5): 
        resampled[i,0:3] = Statistics_of_Simulation(Result_sorted_5[j,0:4], number_of_runs, ratio, l, h, max_number_of_steps, Dist_Matrix_1,Dist_Matrix_2,Dist_Matrix_3, radius)[0:3]
