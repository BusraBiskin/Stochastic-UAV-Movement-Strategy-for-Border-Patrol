...
def Neighbourhood(M, number_of_runs, ratio, l, h, max_number_of_steps, Dist_Matrix_1, Dist_Matrix_2, Dist_Matrix_3,radius):
    ...
    stats = Statistics_Plural(V1, number_of_runs, len(V1)-1, ratio, l, h, max_number_of_steps, Dist_Matrix_1, Dist_Matrix_2, Dist_Matrix_3,ratio) 
    stats = [row[2] for row in stats]       
            
    M1 = V1[stats.index(max(stats)),]
