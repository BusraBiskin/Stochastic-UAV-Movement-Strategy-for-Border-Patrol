        ...
        if accept == 0:
            ...
            while m != 10 and cr1 != 5 :
                ...
                if r < P_s:
                    ...
                    N = N[0:(n+1)]
                    X_ARS = Neighbourhood(N, number_of_runs, l, h, max_number_of_steps, radius)
...
for j in range(5):
    ...
    Result_sorted_5[j,4] = np.average(resampled[0:5,2])

"best solution"
best_soln_sort = Result_sorted_5[(-Result_sorted_5[:,4]).argsort()]
best_soln = best_soln_sort[0,0:5]
