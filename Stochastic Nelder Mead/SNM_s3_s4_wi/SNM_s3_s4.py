...
f = Statistics_Plural(V, number_of_runs, n, ratio, l, h, Dist_Matrix_1, Dist_Matrix_2, Dist_Matrix_3, radius) 
...
while elapsed < 400:
    ...
    if len(np.where(X_ref < 0)) > 0:
        ...
        g_X_ref = - Statistics_of_Simulation(X_ref, number_of_runs, ratio, l, h, Dist_Matrix_1, Dist_Matrix_2, Dist_Matrix_3, radius)[2]
    ...
    if g_X_ref < g_X_min:
        ...
        if len(np.where(X_exp < 0)) > 0:
            ...
            g_X_exp =  - Statistics_of_Simulation(X_exp, number_of_runs, ratio, l, h, Dist_Matrix_1, Dist_Matrix_2, Dist_Matrix_3, radius)[2]
    ...
    if g_X_ref >= g_X_2max:
        ...
        if g_X_2max <= g_X_ref and g_X_ref < g_X_max:
            ...
            if len(np.where(X_cont < 0)) > 0:
                ...
                g_X_cont = - Statistics_of_Simulation(X_exp, number_of_runs, ratio, l, h, Dist_Matrix_1, Dist_Matrix_2, Dist_Matrix_3, radius)[2]
        ...
        if g_X_ref >= g_X_max:
            ...
            g_X_cont = - Statistics_of_Simulation(X_cont, number_of_runs, ratio, l, h, Dist_Matrix_1, Dist_Matrix_2, Dist_Matrix_3, radius)[2]
        ...
        if accept == 0:
            ...
            while m != 10 and cr1 != 5 :
                ...
                if r < P_s:
                    ...
                    X_ARS = Neighbourhood(N, number_of_runs, ratio, l, h, Dist_Matrix_1, Dist_Matrix_2, Dist_Matrix_3,radius)
                ...
                g_X_ARS = - Statistics_of_Simulation(X_ARS, number_of_runs, ratio, l, h, Dist_Matrix_1, Dist_Matrix_2, Dist_Matrix_3, radius)[2]
                cr1 += 1
...
for j in range(4):
    ...
    for i in range(5):
        resampled[i,0:3] = Statistics_of_Simulation(V_sort[j,0:8], number_of_runs, ratio, l, h, Dist_Matrix_1,Dist_Matrix_2,Dist_Matrix_3, radius)[0:3]
