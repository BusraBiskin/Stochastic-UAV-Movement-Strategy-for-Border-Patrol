...
def Statistics_Plural(V, number_of_runs, n, ratio, l, h, max_number_of_steps, Dist_Matrix_1, Dist_Matrix_2, Dist_Matrix_3, radius, time_step):
    ...
    for i in range(n):
        ...
        for j in range(number_of_runs):
            ...
            while D < 1 and t < (Dist_Matrix.shape[1]-1)*ratio :
                ...
                u = UAV_Movement(u, M1, l, h) #UAV makes a move               
