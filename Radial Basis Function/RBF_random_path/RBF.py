...
max_number_of_steps = l * ratio

#target movement probability
T = [0.8, 0, 0.1, 0.1]
...
f = Statistics_Plural(V, T, number_of_runs, n, ratio, l, h, max_number_of_steps) 
...
while elapsed < 400:
    ...
    PoS_X = Statistics_of_Simulation(X, T, number_of_runs, ratio, l, h, max_number_of_steps)[2]
...
for j in range(5):
    ...
    for i in range(5):
        resampled[i,0:3] = Statistics_of_Simulation(Result_sorted_5[j,0:8], T, number_of_runs, ratio, l, h, max_number_of_steps)[0:3]
